            ...
            <div className="grid grid-cols-2 gap-[var(--space-card-gap)] sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5">
              {visible.map((a) => {
                ...
                return (
                  ...
                  >
                    <div className="relative overflow-hidden rounded-[var(--radius-cover)] shadow-lg shadow-black/40 transition duration-200 group-hover:-translate-y-2.5 group-hover:shadow-xl group-hover:shadow-black/50">
