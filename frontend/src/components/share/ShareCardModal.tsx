...
export function ShareCardModal() {
  ...
  const [orientation, setOrientation] = useState<'portrait' | 'landscape'>('portrait') // 拼贴卡取向
  ...
  // 最终 spec：叠加评论 / 弹窗内选的主题色 / 背景样式 / 拼贴取向
    ...
    () =>
      spec
        ? {
            ...
            accentHex: accent,
            bgStyle: bgMode,
            ...(spec.kind === 'collage' ? { orientation } : {}),
          }
        : null,
    [spec, comment, accent, bgMode, orientation],
  )
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 背景样式 + 拼贴取向（拼贴卡） + 主题色（弹窗内临时切换，不影响应用设置） */}
