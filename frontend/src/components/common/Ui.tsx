...
/** 分批续拉指示（我喜欢 / 唱片架）：底部整块空白中央的紧凑小条，
 *  spinner + 主题色高亮；宽度收紧（小 spinner + 小字号） */
export function LoadingMore({ text = '加载中…' }: { text?: string }) {
  return (
    <div className="flex items-center justify-center gap-1.5 text-xs font-medium text-accent-soft">
